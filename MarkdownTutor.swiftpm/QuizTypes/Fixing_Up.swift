...
struct Fixing_Up_Question {
    let id = UUID()
    let md_string:String
}

// Pass written markdown in quiz view
// For example
/*
 @State var question_1_fixing_editArea:String = "TEST"
 */

struct Fixing_Up_View:View{
        ...
        TabView(selection: $view_index){
            VStack{
                if (is_show_template) {
                    ...
                    Text("Try modify the markdown to produce the result below")
                        .fontWeight(.medium)
